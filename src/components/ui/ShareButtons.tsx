  ...
  return (
    <div className="flex items-center gap-2">
      {compact ? (
        ...
        <span className="text-xs text-gray-500">{t('share.label')}</span>
      )}
      <a
        ...
        title="Facebook"
        className="p-1.5 rounded text-gray-400 hover:text-[#1877F2] hover:bg-dark-700 transition-colors"
        aria-label="Facebook"
      >
      ...
      <a
        ...
        rel="noopener noreferrer"
        title="WhatsApp"
        className="p-1.5 rounded text-gray-400 hover:text-[#25D366] hover:bg-dark-700 transition-colors"
        aria-label="WhatsApp"
      >
        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
